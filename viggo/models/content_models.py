...
class DocumentProcessingRequest(BaseModel):
    ...
    chunking_config: Optional[ChunkingRequest] = Field(None, description="Chunking configuration")
    entity_extraction_config: Optional[EntityExtractionRequest] = Field(None, description="Entity extraction configuration")
    content_filtering_config: Optional[ContentFilterRequest] = Field(None, description="Content filtering configuration")
