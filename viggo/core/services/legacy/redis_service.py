#!/usr/bin/env python3
"""
Redis Cache Service for Viggo Hybrid RAG System.

Provides intelligent caching for:
- Query results with TTL
- Embeddings with semantic similarity
- Performance metrics
- Session data
"""
...
class RedisService:
    ...
    def cache_query_result(self, query: str, top_k: int, page_filter: Optional[int], 
    ...
    def get_cached_query_result(self, query: str, top_k: int, 
                               page_filter: Optional[int]) -> Optional[Dict]:
        """
